...
void Settings() {
	...
	while (chois < 1 || chois > 5)
	{
		...
		case 2: {
			system("cls");
			cout << "[1] Цвет крестика " << "\x1b[" << ColorX << "mX\x1b[0m " << endl;
			cout << "[2] Цвет нолика " << "\x1b[" << ColorO << "mO\x1b[0m " << endl;
			cout << "[3] Выход" << endl;
			chois = 0;
		...
		while (chois < 1 || chois > 4)
		{
			...
			case 1: {
				...
				if (win == 1) {
					...
					system("cls");
					cout << "выйграли " << "\x1b[" << ColorX << "mкрестики\x1b[0m " << endl;
					...
					system("cls");
					cout << "выйграли " << "\x1b[" << ColorO << "mнолики\x1b[0m " << endl;
					cout << "Нажмите любую кнопку" << endl;
					cin >> contune;
					system("cls");
				}
